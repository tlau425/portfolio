                ...
                <div className="project-card__stack">
                  <div className="stack__card project-card__tech">
                    <img
                      ...
                      alt="React"
                    />
                    <p className="stack__overlay--projects sb2">React</p>
                  </div>
                  <div className="stack__card project-card__tech">
                    <img
                      className="stack__icon project-card__icon"
                      ...
                      alt="Node"
                    />
                    <p className="stack__overlay--projects sb2">Node.js</p>
                  </div>
                  <div className="stack__card project-card__tech">
                    <img
                      className="stack__icon project-card__icon"
                      ...
                      alt="NodeExpress"
                    />
                    <p className="stack__overlay--projects sb2">Node Express</p>
                  </div>
                  <div className="stack__card project-card__tech">
                    <img
                      className="stack__icon project-card__icon"
                      ...
                      alt="MySQL"
                    />
                    <p className="stack__overlay--projects sb2">MySQL</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="project-card__stack">
                <div className="stack__card project-card__tech">
                  <img
                    ...
                    project-card__icon
                  />
                  <p className="stack__overlay--projects sb2">Javascript</p>
                </div>
                <div className="stack__card project-card__tech">
                  <img
                    className="stack__icon project-card__icon"
                    ...
                    alt="Ruby"
                  />
                  <p className="stack__overlay--projects sb2">Ruby</p>
                </div>
                <div className="stack__card project-card__tech">
                  <img
                    className="stack__icon project-card__icon"
                    ...
                    alt="Ruby on Rails"
                  />
                  <p className="stack__overlay--projects sb2">Ruby on Rails</p>
                </div>
                <div className="stack__card project-card__tech">
                  <img
                    className="stack__icon project-card__icon"
                    ...
                    alt="Postgres"
                  />
                  <p className="stack__overlay--projects sb2">Postgres</p>
                </div>
              </div>
            </div>
          </div>
